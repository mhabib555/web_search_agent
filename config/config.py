...
# Make the configuration a function
def initialize_config():
    """
    Initializes and returns configured language models and a base agent.
    This function should be called explicitly to set up the configuration.
    """
    ...
    try:
        ...
        return llm_model, llm_lite_model, tavily_client, base_agent
...
# The __name__ check prevents this from running on import
if __name__ == "__main__":
    llm_model, llm_lite_model, tavily_client, base_agent = initialize_config()
else:
    # In a module, you might want to call this once
    # or expose the function for other modules to call
    llm_model, llm_lite_model, tavily_client, base_agent = initialize_config()